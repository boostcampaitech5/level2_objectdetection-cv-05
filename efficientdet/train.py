...
def get_args():
    ...
    parser.add_argument('-c', '--compound_coef', type=int, default=4, help='coefficients of efficientdet-d4')
    ...
    parser.add_argument('-w', '--load_weights', type=str, default=None,
                        ...
                        # /opt/ml/Yet-Another-EfficientDet-Pytorch/weights/efficientdet-d4.pth
