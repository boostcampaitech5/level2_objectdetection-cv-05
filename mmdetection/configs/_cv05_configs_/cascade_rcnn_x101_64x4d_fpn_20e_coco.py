...
TRAIN_JSON_DIR = '/opt/ml/dataset/train_new.json'
VAL_JSON_DIR = '/opt/ml/dataset/val_new.json'
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/opt/ml/dataset/train_new.json',
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='cascade_rcnn_r152_64x4d_fpn_50e'))
    ])
...
resume_from = None
workflow = [('train', 1)]
model_root = '/opt/ml/baseline/mmdetection/'
work_dir = './cascade_rcnn_r152_64x4d_fpn_50e'
auto_resume = False
gpu_ids = [0]
