...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/opt/ml/train_new.json',
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            interval=1000,
            init_kwargs=dict(
                project='jamong', entity='boostcamp-cv5', name='c50b2'))
    ])
